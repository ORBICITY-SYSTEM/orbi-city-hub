 ...
 * Run with: node fix-logistics.js
 */
...
async function fixLogistics() {
  ...
  try {
    ...
    console.log(`✅ ${inventoryItems.length} room inventory items inserted\n`);
    ...
    const feniItem = items.find((_, idx) => STANDARD_ITEMS[idx].item_name === 'ფენი');
