...
const mockTransactions = [
  ...
  { id: "TRX-003", date: "2025-08-02", type: "revenue", source: "WhatsApp", apartment: "A 3041", guest: "პაშკოვსკი ჯაბა", amount: 150, commission: 30, net: 120, status: "completed" },
  ...
  { id: "TRX-010", date: "2025-08-11", type: "revenue", source: "WhatsApp", apartment: "A 2441", guest: "მელიქიშვილი ნინი", amount: 300, commission: 60, net: 240, status: "completed" },
  { id: "TRX-011", date: "2025-08-13", type: "revenue", source: "WhatsApp", apartment: "A 3041", guest: "ბუხრაშვილი ელენე", amount: 160, commission: 30, net: 130, status: "completed" },
  { id: "TRX-012", date: "2025-08-14", type: "revenue", source: "WhatsApp", apartment: "A 3041", guest: "ღლონტი ეკატერინე", amount: 900, commission: 180, net: 720, status: "completed" },
  ...
  { id: "TRX-018", date: "2025-08-27", type: "revenue", source: "WhatsApp", apartment: "A 3041", guest: "გუბელაძე სალომე", amount: 800, commission: 150, net: 650, status: "completed" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">ტრანზაქციები</h2>
          <p className="text-sm text-gray-600">ფინანსური ოპერაციების სრული ჩანაწერი</p>
        </div>
        <Button>
