/**
 * PageHeader Component - Unified Header for All Dashboard Pages
 * 
 * Features:
 ...
 * 
 * Orbi City Sea View Aparthotel Theme
 */
...
export function PageHeader({ title, subtitle, icon, className, children }: PageHeaderProps) {
  return (
